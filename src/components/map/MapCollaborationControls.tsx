...
/**
 * Map overlay: open trip collaboration sheet (chat, members, activity) — Pro/Team + saved trip.
 */
      ...
      <div className={cardClassDisabled}>
        <Tooltip>
          ...
          <TooltipContent side="left">
            Save the trip and use Pro for chat, members, and activity
          </TooltipContent>
        </Tooltip>
      </div>
    );
  ...
  return (
    <div className={cardClass}>
      <Tooltip>
        ...
        <TooltipContent side="left">Chat, members, and activity</TooltipContent>
      </Tooltip>
    </div>
  );
}
